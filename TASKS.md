...
| DEMO-12 | Add demo consumer experiment controls for processing enablement and deserialization dispatcher selection.                                                                                              | DONE |
| DEMO-13 | Split demo business services into explicit blocking and suspend paths, and keep consumer handlers as thin service adapters.                                                                            | DONE |
| DEMO-14 | Add comparable Spring Kafka record metrics with a consumer implementation tag shared with CKC metrics.                                                                                                  | DONE |
...
| DOC-1 | Add a documentation task scope for repository documentation, task history, working rules, and project notes. | DONE |
