...
try {
    ...
    $commands = @{
        commands = @(
            ...
            "cp `"$repoTarget/infra/shared/grafana/provisioning/dashboards/ckc.yml`" /opt/ckc-runner/observability/grafana/provisioning/dashboards/ckc.yml",
            "cp `"$repoTarget/infra/shared/grafana/provisioning/datasources/prometheus.yml`" /opt/ckc-runner/observability/grafana/provisioning/datasources/prometheus.yml",
            "cp `"$repoTarget/infra/shared/grafana/dashboards/ckc-overview.json`" /opt/ckc-runner/observability/grafana/dashboards/ckc-overview.json",
            'echo synced=true',
