...
docker build -f ckc-demo/Dockerfile -t ckc-perf/demo:latest ckc-demo
docker build -f ckc-demo-stubs/Dockerfile -t ckc-perf/demo-stubs:latest ckc-demo-stubs
