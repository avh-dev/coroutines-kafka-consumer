...
apt-get update
apt-get install -y ca-certificates curl gnupg iproute2 iptables lsb-release linux-tools-common linux-tools-generic openjdk-21-jre-headless python3-yaml
