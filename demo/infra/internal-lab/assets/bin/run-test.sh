...
write_run_metadata() {
  ...
  export EXPERIMENT_NAME EXPERIMENT_TARGET_NAME EXPERIMENT_TARGET_INDEX EXPERIMENT_TARGET_TOTAL EXPERIMENT_RUN_VARIANT_LABEL
...
metadata = {
    ...
    "experiment": {
        ...
        "variant": env("EXPERIMENT_RUN_VARIANT_LABEL"),
    },
