...
write_run_metadata() {
  ...
  export KAFKA_CONSUMER_FETCH_MIN_BYTES KAFKA_CONSUMER_FETCH_MAX_WAIT_MS KAFKA_CONSUMER_MAX_POLL_RECORDS KAFKA_CONSUMER_FETCH_MAX_BYTES KAFKA_CONSUMER_MAX_PARTITION_FETCH_BYTES
