...
ETA_MODEL_BASE_URL=http://127.0.0.1:18080
FLAVOUR_MODEL_BASE_URL=http://127.0.0.1:18080
REGISTRY_BASE_URL=http://127.0.0.1:18080
AUDIT_LOG_ENABLED=true
DEMO_CONSUMER_PROCESSING_ENABLED=true
ORDER_PROCESSING_MODE=AT_LEAST_ONCE_NO_ORDERING
ORDER_WORKER_CONCURRENCY=20
ORDER_POLL_LOOP_CONCURRENCY=1
ORDER_WORK_CHANNEL_CAPACITY=1024
BATCH_PROCESSING_MODE=AT_LEAST_ONCE_NO_ORDERING
