...
LOAD_LAB_TERRAFORM_DIR="${REPO_DIR}/demo/infra/aws/assets/terraform/load-lab"
RUNNER_TERRAFORM_DIR="${REPO_DIR}/demo/infra/aws/terraform/runner"
ECR_TERRAFORM_DIR="${REPO_DIR}/demo/infra/aws/terraform/ecr"
