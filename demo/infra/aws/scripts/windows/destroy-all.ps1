...
$loadLabTerraformDir = Join-Path $repoRoot "demo\infra\aws\assets\terraform\load-lab"
$runnerTerraformDir = Join-Path $repoRoot "demo\infra\aws\terraform\runner"
$ecrTerraformDir = Join-Path $repoRoot "demo\infra\aws\terraform\ecr"
