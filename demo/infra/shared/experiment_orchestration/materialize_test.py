...
class MaterializeTest(unittest.TestCase):
    def test_smoke_repeat_uses_one_minute_single_target_with_minimal_windows(self) -> None:
        ...
        self.assertEqual(
            {"name": "max-load", "start": "30s", "duration": "1s"},
            workload["measurement_window"],
        )
        self.assertEqual("30s", workload["diagnostics"][0]["at"])
        self.assertEqual("1s", workload["diagnostics"][0]["duration"])
