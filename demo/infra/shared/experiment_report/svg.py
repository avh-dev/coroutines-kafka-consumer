...
def environment_topology_svg(report: ExperimentReport) -> str:
    ...
    if kafka_mode != "docker":
        ...
        body = [
            ...
            '<text class="card-title" x="128" y="335">CKC demo app</text>',
            ...
            '<text class="card-title" x="388" y="335">CKC demo stubs</text>',
            ...
            '<rect x="70" y="500" width="485" height="250" rx="8" fill="#ffffff" stroke="#94a3b8" stroke-dasharray="5 4"/>',
            '<text class="card-title" x="88" y="527">Observability inside Kubernetes</text>',
            '<rect x="90" y="550" width="205" height="130" rx="7" fill="#fff7ed" stroke="#e6522c"/>',
            service_icon("prometheus", 106, 570, 30),
            f'<text class="card-title" x="148" y="589">{esc(component_title("Prometheus"))}</text>',
            '<text class="muted" x="106" y="630">Metrics store</text>',
            '<text class="muted" x="106" y="649">Scrapes apps and exporters</text>',
            '<rect x="330" y="550" width="205" height="130" rx="7" fill="#f5f3ff" stroke="#7c3aed"/>',
            service_icon("alloy", 346, 570, 30),
            f'<text class="card-title" x="388" y="589">{esc(component_title("Grafana Alloy"))}</text>',
            '<text class="muted" x="346" y="630">Kubernetes pod logs</text>',
            '<text class="muted" x="346" y="649">Forwards to Loki</text>',
            ...
            f'<text class="card-title" x="703" y="335">{esc(kafka_title.replace(" · host container", ""))}</text>',
            ...
            f'<text class="card-title" x="703" y="460">{esc(redis_title.replace(" · host container", ""))}</text>',
            ...
            '<path d="M183 415 V466 H645" fill="none" stroke="#475569" stroke-width="2" marker-end="url(#arrow)"/>',
